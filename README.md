...
"RF.distances" contains a script for replicating several statistics and figures in the manuscript, "PIS_rf_dist_collapsed.R", output tables, and alignment/genetree files for each dataset. The R-script also contains code for replicating ILS analysis of phylogenetic triplets.
